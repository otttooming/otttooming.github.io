...
export type MdxFrontmatterFeaturedFilterInput = {
  ...
  illustration?: Maybe<FileFilterInput>;
  width?: Maybe<IntQueryOperatorInput>;
  height?: Maybe<IntQueryOperatorInput>;
...
export type ProjectsListQueryQueryVariables = {};


export type ProjectsListQueryQuery = (
  { __typename?: 'Query' }
  & { allMdx: (
    { __typename?: 'MdxConnection' }
    & { nodes: Array<(
      ...
      & { frontmatter?: Maybe<(
        { __typename?: 'MdxFrontmatter' }
        & Pick<MdxFrontmatter, 'title' | 'company' | 'git' | 'link' | 'kind'>
        & { featured?: Maybe<(
          { __typename?: 'MdxFrontmatterFeatured' }
          & Pick<MdxFrontmatterFeatured, 'background' | 'fit'>
          & { image?: Maybe<(
            { __typename?: 'File' }
            & { childImageSharp?: Maybe<(
              { __typename?: 'ImageSharp' }
...
export type TechnologiesFrontmatterFragmentFragment = (
  { __typename?: 'MdxFrontmatter' }
  & Pick<MdxFrontmatter, 'tags' | 'kind' | 'title'>
  & { featured?: Maybe<(
    { __typename?: 'MdxFrontmatterFeatured' }
    & Pick<MdxFrontmatterFeatured, 'background' | 'width' | 'height' | 'alt'>
    & { illustration?: Maybe<(
      { __typename?: 'File' }
      & Pick<File, 'publicURL'>
    )> }
...
export type TechnologiesListQueryQueryVariables = {};


export type TechnologiesListQueryQuery = (
  { __typename?: 'Query' }
  & { allMdx: (
    { __typename?: 'MdxConnection' }
    & { nodes: Array<(
    ...
    & { nodes: Array<(
      ...
      & { frontmatter?: Maybe<(
        { __typename?: 'MdxFrontmatter' }
        & Pick<MdxFrontmatter, 'title' | 'company' | 'git' | 'link' | 'kind' | 'tech'>
        & { featured?: Maybe<(
          { __typename?: 'MdxFrontmatterFeatured' }
          & Pick<MdxFrontmatterFeatured, 'background' | 'fit'>
          & { image?: Maybe<(
...
export type AboutPostQueryQueryVariables = {
  id?: Maybe<Scalars['String']>;
};


export type AboutPostQueryQuery = (
  { __typename?: 'Query' }
  & { mdx?: Maybe<(
    { __typename?: 'Mdx' }
    & Pick<Mdx, 'id' | 'body'>
    & { frontmatter?: Maybe<(
      { __typename?: 'MdxFrontmatter' }
      & Pick<MdxFrontmatter, 'title' | 'tags'>
      & { featured?: Maybe<(
        { __typename?: 'MdxFrontmatterFeatured' }
        & Pick<MdxFrontmatterFeatured, 'width' | 'height' | 'alt'>
        & { illustration?: Maybe<(
          { __typename?: 'File' }
          & Pick<File, 'publicURL'>
        )> }
...
export type ProjectPostQueryQueryVariables = {
  id?: Maybe<Scalars['String']>;
};


export type ProjectPostQueryQuery = (
  { __typename?: 'Query' }
  & { mdx?: Maybe<(
    { __typename?: 'Mdx' }
    & Pick<Mdx, 'id' | 'body'>
