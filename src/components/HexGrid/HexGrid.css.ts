...
export const hex = styleVariants<Record<string, unknown>>({
  typescript: [hexBase, { backgroundColor: '#007acc' }],
  redux: [hexBase, { backgroundColor: '#764abc' }],
  gatsby: [hexBase, { backgroundColor: '#663399' }],
  react: [hexBase, { backgroundColor: '#20232a' }],
  graphql: [hexBase, { backgroundColor: 'rgba(221,23,151,0.75)' }],
});
