...
const Iglu = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="logo-iglu"
    strokeWidth={0.501}
    ...
    version="1.1"
    overflow="visible"
    viewBox="0 0 340.158 269.292"
    {...props}
  >
    <defs>
      {/* Markers and filters as in SVG */}
      <marker
        id="DefaultArrow2"
