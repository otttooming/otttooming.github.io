...
First of all, I want to introduce our amazing team, that we assembled in the [Student Startup Camp 2019](https://garage48.org/events/student-startup-camp-tartu-2019) that was held in Tartu.

[Kaarel Loide](https://ee.linkedin.com/in/kaarel-loide-426632175) - front-end developer,
[Aksel Jänes](https://ee.linkedin.com/in/aksel-j%C3%A4nes-13b455ba) - designer,
[Kustas Budrikas](https://ee.linkedin.com/in/kustas-budrikas-14aa92158) - designer,
[Anette Kuklane](https://ee.linkedin.com/in/anette-maria-kuklane-365648127) - business and marketing,
Aysen Suleymanova - front-end developer,
[Kertrud Järg](https://ee.linkedin.com/in/kertrud-j%C3%A4rg-8a826b134) - analyst and product management,
[Ott Tooming](/) - team lead and full-stack developer

For our backgrounds, all of us are students and continuing our education in various disciplines.
...
![base-camp](base-camp-4.jpg)

![base-camp](base-camp-1.jpg)

![base-camp](base-camp-3.jpg)

![student startup camp](ssg-1.jpeg)

</MasonryGallery>

Our amazing team got it's wings in the [Student Startup Camp 2019](https://garage48.org/events/student-startup-camp-tartu-2019) where we won the ["Best Design Special Award"](http://ideelabor.ut.ee/news/student-startup-camp-2019-winners-are-here).

Afterward, we were shortlisted for the [Garage48 Base Camp Spring 2019](https://www.garage48.org/events/base-camp-spring-2019) hackathon where we also got directed by an amazing group of mentors ["Base Camp Vol.2 Magnifies the Entire Hackathon Experience"](http://garage48.org/blog/base-camp-vol-2-magnifies-the-entire-hackathon-experience).

The seed for the idea to create a veterinary collaboration tool emerged from close interaction with industry insiders that many of our team members are involved in.

We are enthusiastic about our field but also have had strong experience in the wider SaaS industry while working for [Pipedrive](/projects/pipedrive-cms/), [Voog](/projects/voog-cms/) and various other companies.

<Illustration>

![medicine](undraw_medicine.svg)

</Illustration>

## What are we solving

PetHealth platform is dedicated to providing a solution that empowers and enhances animal healthcare through collaboration between veterinary doctors.
...
And, beyond any specific facilitation for patient records, we believe harmonized data access can usher in an ever greater understanding of the medical conditions veterinarians are faced daily.
...
Our greatest aspiration is to connect a global community of veterinarians, students, and organizations invested in finding new approaches to animal healthcare.

<Illustration>

![pet adoption](undraw_pet_adoption.svg)
...
![product tour](undraw_product_tour.svg)

</Illustration>

## Existing solutions

Prevailing methods and solutions in the market do not adequately enable the full potential for collaboration in the patient diagnosis process.
While there are a plethora of solutions on the market offering patient management systems, all of them are limited to feed information gathered from patient care to a walled garden, restricted to a specific clinic and don't tap into the collaborative potential of the field.
...
And on the other hand for our expectation, we believe that creating a platform from the ground up to facilitate consultations and shared patient records as a first-class citizen will net positive feedback to all participants.

Our dream is to connect veterinarians to their colleagues in the field and to build a more open world.

<Illustration>

![detailed analysis](undraw_detailed_analysis.svg)
...
![setup wizard](undraw_setup_wizard.svg)

</Illustration>

### Separate channels as a disjointed experience

In the current situation, there are a plethora of different channels to find information and ask for counsel if there is a patient that needs a diagnostic consultation.
This creates a situation that you are left asking "Did I send it as email", "Was it in Slack", "Did I create a post for it?" etc.

The most grievous offense resulting from these kinds of implementations is the temporary nature of the information transfer.

This lack of harmonized access to data, while inconvenient, is also a major hindrance on productivity, necessitating redundant information duplication and dealing with platform shortcomings.

<Illustration>

![segment analysis](undraw_segment_analysis.svg)
...
![checking boxes](undraw_checking_boxes.svg)
...
![product teardown](undraw_product_teardown.svg)
...
For long term goals, we want to aggregate research-grade data for scientific research in addition to working with the community to enhance their daily experiences.
We strive to be a connector for the research community and the day to day business end of veterinary practice.

<Illustration>

![confirmation](undraw_confirmation.svg)
...
![teaching](undraw_teaching.svg)

</Illustration>

## Technical implementation

For the technical side, we use React and Node.js microservices approach. Powered by the amazing Prisma Client and a GraphQL API we hold confident that we can rapidly iterate to validate our business idea.
We want to keep our stack as accessible and lean as possible to handle domain-specific necessities rapidly.

Possessing long term experience with JavaScript/TypeScript ecosystem, we hold great confidence in our ability to fulfill the best in ourselves and strive to deliver the best experience to our clients.

<Illustration>

![prototyping process](undraw_prototyping_process.svg)

</Illustration>

## Prototype

Our completed MVP prototype was launched in [Student Startup Camp](https://garage48.org/events/student-startup-camp-tartu-2019) and we iterated on the idea during the [Alpine House Base Camp](https://www.garage48.org/events/base-camp-spring-2019) by adding specific medical condition view support.
...
![design landing](design-landing.png)

![design login 1](design-login-1.png)

![design login 2](design-login-2.png)

![design browse 1](design-browse-1.png)

![design browse 2](design-browse-2.png)

![design categories](design-categories.png)

![design details condition](design-details-condition.png)

![design details patient](design-details-patient.png)

![design patients 1](design-patients-1.png)

![design patients 1](design-patients-1.png)

![design 404](design-404.png)
...
![thesis 1](thesis_1.png)

![thesis 2](thesis_2.png)

![thesis 3](thesis_3.png)

![thesis 4](thesis_4.png)

![thesis 5](thesis_5.png)

![thesis 6](thesis_6.png)

![thesis 7](thesis_7.png)

![thesis 8](thesis_8.png)

![thesis 9](thesis_9.png)

![thesis 10](thesis_10.png)

![thesis 11](thesis_11.png)

![thesis 12](thesis_12.png)

![thesis 13](thesis_13.png)

![thesis 14](thesis_14.png)

![thesis 15](thesis_15.png)
