...
Worked in a team where we were tasked with building a new microservice for the business delivery dashboard.
This was in part of the greater expansion for logistics infrastructure that is already used by thousands of users in the Baltic sea region.
